  ...
  return (
    <>
      <div className="mb-3">
        ...
        />
        {!hasQuestionText && <Form.Control.Feedback type="invalid">Question text is required</Form.Control.Feedback>}
      </div>
      ...
      {blankTexts.map((blankText, index) => (
        <Row key={index} className="mb-2">
          <Col>
            <Form.Control
              type="text"
              placeholder="Add balnk text here"
              value={blankText}
      ...
      <Row className="mb-3">
        <Col xs="auto">
          <Button variant="outline-secondary" size="sm" className="d-flex align-items-center" onClick={addBlank}>
