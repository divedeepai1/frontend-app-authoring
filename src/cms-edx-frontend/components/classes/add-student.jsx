...
const StudentDetails = ({ nextStep, prevStep }) => {
  ...
  return (
    <div className="p-4 class-div-style">
      ...
      <p className="mb-3">Select how would you like to add new students to this class.</p>
      ...
      <button className="secondary-button px-3  py-2 ml-3" onClick={prevStep}>Back</button>
    </div>
