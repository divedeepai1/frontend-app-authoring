...
export function ManagementCard({ title }) {
  ...
  return (
    <Card style={{  borderWidth: "1px" }} className="text-center" onClick={() => title =="Manage Classes & Students" ? navigate("/classes") : title =="Manage Courses & Curriculum" ? navigate("/curriculum") : title =="Reports" ? navigate("/reports"):""}>
